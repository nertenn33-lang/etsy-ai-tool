    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 p-6">
            <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-slate-900/50 p-8 backdrop-blur-xl text-center shadow-2xl">
                ...
                >
                    <button
                        className="flex w-full items-center justify-center gap-3 rounded-lg bg-white py-3 text-sm font-semibold text-slate-950 transition-transform hover:scale-105 hover:bg-slate-200"
                        type="submit"
                    >
                        {/* Google Icon SVG */}
